...
namespace GlobalFlameMinistry.API.Interfaces.BulkEmail
{
    ...
    {
        Task<BulkEmailResponseDto> SendNowAsync(SendBulkEmailDto dto, string adminUserId, string adminName);
        Task<BulkEmailResponseDto> ScheduleAsync(SendBulkEmailDto dto, string adminUserId, string adminName);
        Task<PagedResult<BulkEmailResponseDto>> GetHistoryAsync(BulkEmailQueryObject query);
